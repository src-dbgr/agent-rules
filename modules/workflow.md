...
| `N4` | Wo `dod:program_design` gilt: **erster Akt** ist der Ein-Seiten-Plan, `passed` **bevor** Produktionscode entsteht; danach Umsetzung in **vertikalen Schnitten** laut Plan, je Schnitt ein ausgeführtes Prüfkommando; Build und Lint grün; keine Geheimnisse; Schnittstellen eingehalten; Arbeitsbranch registriert | Plan-Artefakt + projektspezifisch Exit 0 |
